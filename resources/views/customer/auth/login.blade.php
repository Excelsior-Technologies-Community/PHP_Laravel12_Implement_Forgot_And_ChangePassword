            ...
            <div>
                ...
                <div class="relative">
                    <input type="password" name="password" id="password" placeholder="Enter your password"
                        class="w-full border border-gray-300 rounded px-4 py-2 pr-12 focus:ring-2 focus:ring-blue-500"
                        required>

                    <!-- Show/Hide Button -->
                    <button type="button" onclick="togglePassword()"
                        class="absolute right-3 top-2 text-gray-600 text-sm">
                        Show
                    </button>
                </div>
                ...
                <div class="text-right mt-1">
                    <a href="{{ route('customer.forgot') }}" class="text-blue-600 hover:underline text-sm">
                        Forgot Password?
                    </a>
                </div>
            </div>
